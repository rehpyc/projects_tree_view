    ...
    def render_project_progress(project)
      ...
      if open_issues > 0
        ...
        s << "<div>Issues: " +
          ...
          progress_bar(issues_closed_percent, :width => '30em', :legend => issues_closed_percent)
      end
      ...
      unless project_versions.empty?
        ...
        project_versions.reverse_each do |version|
          unless version.completed?
            ...
            s << "</div><br />" +
            progress_bar([version.closed_percent, version.completed_percent], :width => '30em', :legend => version.completed_percent)
          end
        end
        s << "</div>"
      end
